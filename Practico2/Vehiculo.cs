...
namespace Practico2
{
    internal class Vehiculo
    {
        ...
        public Vehiculo(int numero, string matricula, string marca, string color, int capacidadTanque, bool disponibilidad, double precioAlquilerDia, int kmLitro)
        {
            this.numero = numero;
        ...
        public double GetPrecioAlquilerDia() => precioAlquilerDia;
